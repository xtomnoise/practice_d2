    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mc_donalds.product')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mc_donalds.order')),
            ],
        ),
        migrations.AddField(
            model_name='order',
